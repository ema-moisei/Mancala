...
Mancala:
    ...
    2. Menu: v Game rules
             v Short Hystory
             - About : creator, surse, etc
             - Sound : fundal, game sounds
             - Game theme?
             v Scores: by player
             v Start game: - Select players: - New player: -Select nickname
                                                          -Choose avatar
...
actual game: - Objective: collect as many rocks as you can in your bank (right side)
    ...
    add to widgets dict all the widgets
...
class Interface:
    def __init__(self):
        ...
        self.play_again = {"y": 6, "x": 10, "sy": 1, "sx": 2}
    ...
    def clicked_del_button(self):
        ...
        # print(self.widgets["right_label"], self.widgets["left_label"], "right label, left label")

        print(self.right_chosen_players, self.left_chosen_players, "r choosen pl, l choosen pl")
    ...
    def selected_pl_l(self, item):
        ...
        print(self.selected_player, "pup")
    ...
    def choose_players(self):
        self.clear_widget()
        self.window.setStyleSheet("background-image: url(choose_playerspls.png);")
...
class Game:
    ...
    def computer_move(self):
        ...
        print(str(self.interface.current_player), "randul calculatorului")
        extra_move = False
        rocks = 0
        hole = -1
        while not rocks:
